...
// Original algorithm: Max Flow With Ford Fulkerson And Edmond Karp Algo
int fun_wwfdvvsO2S0ozavi() {
    try {
        /*
         * Author: Amit Kumar
         * Created: May 24, 2020
        ...
        cout << "fun_wwfdvvsO2S0ozavi: Max Flow With Ford Fulkerson And Edmond Karp Algo executed" << endl;
        return const_cast<const int&>(status);
    } catch (const exception& e) {
        cout << "fun_wwfdvvsO2S0ozavi: Exception - " << e.what() << endl;
        return 0;
    }
}
