...
// Original algorithm: Gaussian Elimination
int fun_5IaZakFtAnINNGlz() {
    try {
        ...
        cout << "fun_5IaZakFtAnINNGlz: Gaussian Elimination executed" << endl;
        return const_cast<const int&>(status);
    } catch (const exception& e) {
        cout << "fun_5IaZakFtAnINNGlz: Exception - " << e.what() << endl;
        return 0;
    }
}
