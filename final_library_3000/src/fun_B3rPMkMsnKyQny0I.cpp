...
// Original algorithm: Ode Midpoint Euler
int fun_B3rPMkMsnKyQny0I() {
    try {
        ...
        ; /* initial value Y = y(x = x_0) */
            ...
            return 0;
                ...
                cout << "Testing Ode Midpoint Euler..." << endl;
                cout << "Algorithm functions available" << endl;

        volatile int status = 1;
        cout << "fun_B3rPMkMsnKyQny0I: Ode Midpoint Euler executed" << endl;
        return const_cast<const int&>(status);
    } catch (const exception& e) {
        cout << "fun_B3rPMkMsnKyQny0I: Exception - " << e.what() << endl;
        return 0;
    }
}
